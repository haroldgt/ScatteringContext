...
%% { 设定要查看数据的文件夹路径。 }
LidarData_path = 'G:/big-data/Semantic-KITTI/LIDAR/dataset/sequences/18/velodyne/'; % 一帧点云的文件路径
Groundtruth_path = 'E:/matrix_labs/lab0_loopGroundtruth_by_pose/semantic-kitti/18.mat';
...
rings_num = 280; % 划分用的圆环数，即Nr。
sectors_num = 240; % 每环划分的扇段数，即Ns。
